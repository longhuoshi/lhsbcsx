...
interface UnaryFunction<R,T>{ R function(T t);}
...
public class Functional {
    ...
    //it with a running with result ,which is finally returned:
    public static <T> T reduce(Iterable<T> seq,Combiner<T> combiner){
        ...
        return null ;// Or thorw exception
    }
    ...
    //Applies a unary predicate to each item in sequence
    ...
    //We can even a UnaryFunction with an "ulp" (Units in the last place):
    ...
    public static void main(String[] args) {
        ...
        print(rbi);
        //The sum of this list is primes is also prime:
