...
//			House h = (House) cth.createNew("main.java.bcsx.practice.generics.House");
//			House h2 = (House) cth.createNew("main.java.bcsx.practice.generics.House","shanghai");
			
			
			
			ClassTypeCreator22 ct = new ClassTypeCreator22();
			Building b = (Building) ct.createNew("main.java.bcsx.practice.generics.Building");
			House h3 = (House) ct.createNew("main.java.bcsx.practice.generics.House","shanghai",1000);
			print(b);
			print(h3);
